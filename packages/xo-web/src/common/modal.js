...
export const FormModal = [
  provideState({
    ...
    effects: {
      ...
      submit: ({ close }) => state => {
        state.props.resolve(state.value)
        close()
      },
    },
    computed: {
  ...
  injectState,
  ({ state: { id, showModal, props = {}, value }, effects }) => (
    <ReactModal show={showModal} bsSize={props.size} onHide={effects.cancel}>
      <ReactModal.Header closeButton>
        <ReactModal.Title>
